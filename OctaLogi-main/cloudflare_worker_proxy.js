...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // 4. Buscar Colaboradores no GLPI (via /search/User com forcedisplay especificando nome, setor e o campo 76878 [USUARIO - CENTRO DE CUSTO])
      const searchUrl = `${baseUrl}/search/User?expand_dropdowns=true&is_deleted=0&range=0-1000&forcedisplay[0]=1&forcedisplay[1]=2&forcedisplay[2]=9&forcedisplay[3]=34&forcedisplay[4]=70&forcedisplay[5]=76878`;
      let userResp = await fetch(searchUrl, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'App-Token': appToken,
